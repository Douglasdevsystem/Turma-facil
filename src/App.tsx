        ...
        <div className="flex-1 bg-white md:flex md:items-center md:justify-center rounded-t-3xl md:rounded-none -mt-3 md:mt-0 px-6 py-8 md:px-16 lg:px-24">
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-3 my-4">
              <div className="flex-1 h-px bg-[#E1E8F5]" />
              <span className="text-xs text-[#6B7A9A]">ou continue com</span>
              <div className="flex-1 h-px bg-[#E1E8F5]" />
            </div>
            <button className="w-full border border-[#E1E8F5] rounded-xl py-3 flex items-center justify-center gap-2 text-sm font-500 text-[#1A2340] hover:bg-[#F4F7FE] transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 48 48"><path fill="#EA4335" d="M24 9.5c3.5 0 6.6 1.2 9.1 3.2l6.8-6.8C35.9 2.3 30.4 0 24 0 14.6 0 6.6 5.4 2.6 13.3l7.9 6.1C12.5 13.1 17.8 9.5 24 9.5z"/><path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.2-.4-4.7H24v8.9h12.7c-.6 3-2.3 5.5-4.8 7.2l7.5 5.8c4.4-4.1 6.9-10.1 6.9-17.2z"/><path fill="#FBBC05" d="M10.5 28.6A14.7 14.7 0 0 1 9.5 24c0-1.6.3-3.2.8-4.6L2.4 13.3A23.8 23.8 0 0 0 0 24c0 3.8.9 7.4 2.6 10.6l7.9-6z"/><path fill="#34A853" d="M24 48c6.4 0 11.8-2.1 15.7-5.8l-7.5-5.8c-2.1 1.4-4.8 2.2-8.2 2.2-6.2 0-11.5-4.2-13.4-9.8l-7.9 6.1C6.5 42.6 14.6 48 24 48z"/></svg>
